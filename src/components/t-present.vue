...
<template>
  ...
  <div class="t-present-backdrop" @click="onClickBackdrop" @touchend="onClickBackdrop" ref="backdrop" v-if="isRender" v-show="isShow" :style="[styles, {zIndex: zIndex - 1}, props.style]"></div>
</template>
